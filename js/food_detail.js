document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productName) {
        ...
        if (product) {
            // 브레드크럼 업데이트
        document.getElementById('main-category-link').href = `all_food.html?category=${product.category}&subCategory=all`;
        document.getElementById('main-category-link').textContent = product.category;
        
        document.getElementById('sub-category-link').href = `all_food.html?category=${product.category}&subCategory=${product.subCategory}`;
